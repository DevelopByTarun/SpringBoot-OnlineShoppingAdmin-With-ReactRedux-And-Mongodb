...
public class EmailAspect {
	...
	@Pointcut("execution(* com.app.MavenSpringBootMvcAopRestApiOnlineShoppingWithReactReduxAndMongodb.dao.IEmailDAO.*(..))")
	...
	@Before("execution(public * com.app.MavenSpringBootMvcAopRestApiOnlineShoppingWithReactReduxAndMongodb.dao.IEmailDAO.sendEmail(..))")
	...
	@After("execution(public * com.app.MavenSpringBootMvcAopRestApiOnlineShoppingWithReactReduxAndMongodb.dao.IEmailDAO.sendEmail(..))")
